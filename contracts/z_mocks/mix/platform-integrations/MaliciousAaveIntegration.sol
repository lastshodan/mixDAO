...
import { 
    IAaveATokenV2,
    IAaveLendingPoolV2,
    ILendingPoolAddressesProviderV2 } from "../../../mix/platform-integrations/IAave.sol";
...
contract MaliciousAaveIntegration is InitializableAbstractIntegration {
    ...
    ****************************************/
     ...
     *      (mIx and corresponding BasketManager)
    ...
    ****************************************/
        ...
        internal
    {
        ...
        // approve the pool to spend the bAsset
        MixHelpers.safeInfiniteApprove(_bAsset, lendingPool);
    }
