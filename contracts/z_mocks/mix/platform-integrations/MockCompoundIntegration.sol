...
import { CompoundIntegration, ICERC20, IERC20, MixHelpers } from "../../../mix/platform-integrations/CompoundIntegration.sol";
...
contract MockCompoundIntegration1 is CompoundIntegration {
        ...
        external
    {
        ...
        MixHelpers.safeInfiniteApprove(rewardToken, liquidator);
