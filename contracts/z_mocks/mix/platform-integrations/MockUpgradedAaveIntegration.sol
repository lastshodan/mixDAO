...
import { InitializableAbstractIntegration, MixHelpers, IERC20 } from "../../../mix/platform-integrations/InitializableAbstractIntegration.sol";

import { IAaveATokenV1, IAaveLendingPoolV1, ILendingPoolAddressesProviderV1 } from "../../../mix/platform-integrations/IAave.sol";
    ...
    ****************************************/
        ...
        onlyGovernor
    {
        ...
        for(uint i = 0; i < bAssetCount; i++){
            MixHelpers.safeInfiniteApprove(bAssetsMapped[i], lendingPoolVault);
        }
    }
        ...
        internal
    {
        address lendingPoolVault = _getLendingPoolCore();
        // approve the pool to spend the bAsset
        MixHelpers.safeInfiniteApprove(_bAsset, lendingPoolVault);
    }
