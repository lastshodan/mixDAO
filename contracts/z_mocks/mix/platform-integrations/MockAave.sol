...
} from "../../../mix/platform-integrations/IAave.sol";
import { AaveIntegration } from "../../../mix/platform-integrations/AaveIntegration.sol";
import { AaveV2Integration } from "../../../mix/platform-integrations/AaveV2Integration.sol";

import { MixHelpers, SafeERC20, SafeMath } from "../../../mix/shared/MixHelpers.sol";
...
contract MockAaveV1 is IAaveLendingPoolV1, ILendingPoolAddressesProviderV1 {
    ...
    function addAToken(address _aToken, address _underlying) public {
        MixHelpers.safeInfiniteApprove(_underlying, _aToken);
