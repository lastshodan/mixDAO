 ...
 * @notice  Structs used in the Mix contract and associated Libs
 */
interface MixStructs {
    ...
    struct Basket {
         ...
         * The collateralisation ratio is used to calc Mix burn rate.
         */
        bool failed;
    ...
    struct Basset {
        ...
        /**
         * @dev 1 Basset * ratio / ratioScale == x Mix (relative value)
         *      If ratio == 10e8 then 1 bAsset = 10 mIxs
