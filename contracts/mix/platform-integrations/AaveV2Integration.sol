...
import { InitializableAbstractIntegration, MixHelpers, IERC20, SafeMath } from "./InitializableAbstractIntegration.sol";
...
contract AaveV2Integration is InitializableAbstractIntegration {
    ...
    ****************************************/
        ...
        onlyGovernor
    {
        ...
        MixHelpers.safeInfiniteApprove(aaveToken, liquidator);
