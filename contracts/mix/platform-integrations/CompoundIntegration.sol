...
import { InitializableAbstractIntegration, MixHelpers, IERC20 } from "./InitializableAbstractIntegration.sol";
...
contract CompoundIntegration is InitializableAbstractIntegration {
    ...
    ****************************************/
        ...
        onlyGovernor
    {
        ...
        MixHelpers.safeInfiniteApprove(compToken, liquidator);
    ...
    ****************************************/
        ...
        internal
    {
        ...
        // Reason for skipping: to ensure that redeemMix is always able to execute
    ...
    ****************************************/
        ...
        onlyGovernor
    {
        ...
        for(uint i = 0; i < bAssetCount; i++){
            ...
            MixHelpers.safeInfiniteApprove(bAsset, cToken);
        }
    }
        ...
        internal
    {
        ...
        MixHelpers.safeInfiniteApprove(_bAsset, _cToken);
    }
