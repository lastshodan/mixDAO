...
import { ICurveBildPool } from "./ICurveBildPool.sol";
    ...
    InitializableModule
{
    ...
    * @param _curvePosition Position of the bAsset in Curves BildPool
