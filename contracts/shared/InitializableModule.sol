...
contract InitializableModule is InitializableModuleKeys {
    ...
    /**
     * @dev Return BildToken Module address from the Nexus
     * @return Address of the BildToken Module contract
     */
    function _bildToken() internal view returns (address) {
        return nexus.getModule(KEY_BILD_TOKEN);
    }
