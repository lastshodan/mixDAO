...
import { MixMachine, MixDetails } from "@utils/machines";
...
export class SystemMachine {
    ...
    constructor(accounts: Address[]) {
        ...
        this.mixMachine = new MixMachine(this);
        ...
        /* **************************************
        Deploy Nexus at minimum, to allow MixMachine access
        *************************************** */
    ...
    public async initialiseMocks(
        ...
        *************************************** */
        this.mUSD = seedMix
            ? await this.mixMachine.deployMixAndSeedBasket(enableUSDTFee)
            : await this.mixMachine.deployMix(enableUSDTFee);
