...
export default async (
    ...
    ****************************************/
    ...
    const c_BildToken = artifacts.require("BildToken");
    // Rewards contracts
    ...
    ****************************************/
    ...
    await deployer.deploy(c_BildToken, d_Nexus.address, default_, { from: default_ });
    const d_BildToken = await c_BildToken.deployed();
    ...
    ****************************************/
    ...
    console.log(`[Bild]: '${d_BildToken.address}'`);
