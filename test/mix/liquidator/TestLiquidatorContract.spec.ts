...
const MockCurve = artifacts.require("MockCurveBildPool");
...
contract("Liquidator", async (accounts) => {
    ...
    let curve: t.MockCurveBildPoolInstance;
    ...
    const redeployLiquidator = async () => {
        // Fake mUSD & uniswap
        mUSD = await MockMix.new("mStable USD", "mUSD", 18, sa.fundManager, 100000000);
