    ...
    context("calculating a multi redeem", async () => {
        const assertRedeemCalc = async (
            ...
            if (expectedLen > 0) {
                ...
                // Important - assert that the sum of the returned values is LT mixQ input
                expect(exactMixQ).bignumber.gte(sumOfRatioedBassets as any);
            }
        };
        ...
        context("in a basket with normal collateral levels", async () => {
            ...
            describe("using unexpected arguments", async () => {
                it("should return 0 if 0 mIx is passed", async () => {
                    /**
                     * MixQ:         0
                     * MaxWeights:      [50, 50, 50, 50]
                     * BassetVaults:    [25, 25, 25, 25]
                ...
                it("should fail if mIx Q is greater than sum of bAssets", async () => {
                    /**
                     * MixQ:         105
                     * MaxWeights:      [50, 50, 50, 50]
                     * BassetVaults:    [25, 25, 25, 25]
            ...
            describe("redeeming relatively largely amount of mIx", async () => {
                it("returns proportional quantities", async () => {
                    /**
                     * MixQ:         220
                     * MaxWeights:      [ 50,  50,  50,  50]
                ...
                it("returns inValid if the mIx quantity is greater than vault balance", async () => {
                    /**
                     * MixQ:         501
                     * MaxWeights:      [ 50,  50,  50,  50]
                     * BassetVaults:    [100, 150, 125, 125]
