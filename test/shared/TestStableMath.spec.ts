...
contract("StableMath", async () => {
    ...
    *************************************** */
    ...
    describe("calling mulRatioTruncate(x, ratio)", async () => {
        it("should calculate correct mIx value from bAsset", async () => {
