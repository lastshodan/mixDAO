...
export interface RewardsDistributionRecipientContract
  extends Truffle.Contract<RewardsDistributionRecipientInstance> {
  "new"(
    _nexus: string,
    _rewardsDistributor: string,
    meta?: Truffle.TransactionDetails
  ): Promise<RewardsDistributionRecipientInstance>;
}

type AllEvents = never;

export interface RewardsDistributionRecipientInstance
