...
export interface MockMixContract extends Truffle.Contract<MockMixInstance> {
  "new"(
    _name: string,
    _symbol: string,
...
export interface MockMixInstance extends Truffle.ContractInstance {
  addMinter: {
