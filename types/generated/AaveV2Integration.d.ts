...
export interface AaveV2IntegrationContract
  extends Truffle.Contract<AaveV2IntegrationInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AaveV2IntegrationInstance>;
}
...
export interface AaveV2IntegrationInstance extends Truffle.ContractInstance {
  approveRewardToken: {
