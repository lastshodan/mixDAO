...
export interface MockMix1Contract extends Truffle.Contract<MockMix1Instance> {
  "new"(
    _name: string,
    _symbol: string,
...
export interface MockMix1Instance extends Truffle.ContractInstance {
  addMinter: {
