...
export interface AaveIntegrationV3Contract
  extends Truffle.Contract<AaveIntegrationV3Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AaveIntegrationV3Instance>;
}
...
export interface AaveIntegrationV3Instance extends Truffle.ContractInstance {
  bAssetToPToken(
    arg0: string,
