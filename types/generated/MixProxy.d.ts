...
export interface MixProxyContract extends Truffle.Contract<MixProxyInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MixProxyInstance>;
}
...
export interface MixProxyInstance extends Truffle.ContractInstance {
  admin: {
