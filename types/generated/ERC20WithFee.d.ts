...
export interface ERC20WithFeeContract
  extends Truffle.Contract<ERC20WithFeeInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ERC20WithFeeInstance>;
}
...
export interface ERC20WithFeeInstance extends Truffle.ContractInstance {
  addMinter: {
