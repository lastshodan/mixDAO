...
export interface AaveIntegrationContract
  extends Truffle.Contract<AaveIntegrationInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AaveIntegrationInstance>;
}
...
export interface AaveIntegrationInstance extends Truffle.ContractInstance {
  bAssetToPToken(
    arg0: string,
