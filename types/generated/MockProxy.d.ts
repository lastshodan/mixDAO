...
export interface MockProxyContract extends Truffle.Contract<MockProxyInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MockProxyInstance>;
}
...
export interface MockProxyInstance extends Truffle.ContractInstance {
  admin: {
