...
export interface GovernableContract
  extends Truffle.Contract<GovernableInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GovernableInstance>;
}
...
export interface GovernableInstance extends Truffle.ContractInstance {
  changeGovernor: {
