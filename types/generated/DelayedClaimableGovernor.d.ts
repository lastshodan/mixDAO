...
export interface DelayedClaimableGovernorContract
  extends Truffle.Contract<DelayedClaimableGovernorInstance> {
  "new"(
    _governorAddr: string,
    _delay: number | BN | string,
    meta?: Truffle.TransactionDetails
  ): Promise<DelayedClaimableGovernorInstance>;
}
...
export interface DelayedClaimableGovernorInstance
