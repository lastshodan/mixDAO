...
export interface MockAaveIntegrationContract
  extends Truffle.Contract<MockAaveIntegrationInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<MockAaveIntegrationInstance>;
}
...
export interface MockAaveIntegrationInstance extends Truffle.ContractInstance {
  bAssetToPToken(
    arg0: string,
  ...
  getBassetsMapped(txDetails?: Truffle.TransactionDetails): Promise<string[]>;
