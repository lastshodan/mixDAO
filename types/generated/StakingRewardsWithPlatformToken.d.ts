...
export interface StakingRewardsWithPlatformTokenContract
  extends Truffle.Contract<StakingRewardsWithPlatformTokenInstance> {
  "new"(
    _nexus: string,
  ...
  ): Promise<StakingRewardsWithPlatformTokenInstance>;
}
...
export interface StakingRewardsWithPlatformTokenInstance
  ...
  platformRewardRate(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  platformTokenVendor(txDetails?: Truffle.TransactionDetails): Promise<string>;

  rewardPerToken(txDetails?: Truffle.TransactionDetails): Promise<[BN, BN]>;
