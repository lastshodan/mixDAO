...
export interface MockNexusContract extends Truffle.Contract<MockNexusInstance> {
  "new"(
    _governorAddr: string,
    _governance: string,
    _manager: string,
    meta?: Truffle.TransactionDetails
  ): Promise<MockNexusInstance>;
}
...
export interface MockNexusInstance extends Truffle.ContractInstance {
  ...
  setLiquidator: {
    (_liquidator: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      _liquidator: string,
  ...
  setSavingsManager: {
    (_savingsManager: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
