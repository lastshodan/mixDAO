...
export interface AaveIntegrationV2Contract
  extends Truffle.Contract<AaveIntegrationV2Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<AaveIntegrationV2Instance>;
}
...
export interface AaveIntegrationV2Instance extends Truffle.ContractInstance {
  bAssetToPToken(
    arg0: string,
  ...
  newMethod(txDetails?: Truffle.TransactionDetails): Promise<boolean>;
