...
export interface BildTokenContract extends Truffle.Contract<BildTokenInstance> {
  "new"(
    _nexus: string,
    _initialRecipient: string,
    bild?: Truffle.TransactionDetails
  ): Promise<BildTokenInstance>;
}
...
export interface BildTokenInstance extends Truffle.ContractInstance {
  addMinter: {
