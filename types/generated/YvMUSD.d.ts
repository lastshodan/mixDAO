...
export interface YvMUSDContract extends Truffle.Contract<YvMUSDInstance> {
  "new"(
    _token: string,
    meta?: Truffle.TransactionDetails
  ): Promise<YvMUSDInstance>;
}
...
export interface YvMUSDInstance extends Truffle.ContractInstance {
  allowance(
    owner: string,
    spender: string,
