...
export interface GovernedMinterRoleContract
  extends Truffle.Contract<GovernedMinterRoleInstance> {
  "new"(
    _nexus: string,
    meta?: Truffle.TransactionDetails
  ): Promise<GovernedMinterRoleInstance>;
}
...
export interface GovernedMinterRoleInstance extends Truffle.ContractInstance {
  addMinter: {
